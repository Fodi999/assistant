...
#[cfg(test)]
mod tests {
    use crate::commands::add_edge::{apply_add_edge, AddEdgeRequest};
    use crate::commands::add_point::{apply_add_point, AddPointRequest};
    use crate::commands::result::PointRefOrGrid;
