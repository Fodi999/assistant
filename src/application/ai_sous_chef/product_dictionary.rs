...
pub fn normalize_ingredient_name(input: &str) -> String {
    ...
    let en_stop = [
        "fresh", "raw", "dried", "frozen", "organic", "natural", "whole", "fillet", "fillets",
        "boneless", "skinless", "smoked", "salted", "canned", "pickled", "grilled", "fried",
        "boiled", "steamed", "ground", "minced", "sliced", "chopped", "diced", "grated", "large",
        "small", "medium", "extra", "premium", "quality", "baby", "young", "wild", "farm",
        "farmed",
    ];
    ...
    // Remove stop-words
    words.retain(|w| !en_stop.iter().any(|s| w == s) && !ru_stop.iter().any(|s| w == s));
...
pub fn is_valid_ingredient_name(name: &str) -> bool {
    ...
    let forbidden_en = [
        "fillet", "fresh", "raw", "frozen", "organic", "dried", "smoked", "grilled", "fried",
        "boiled", "boneless", "skinless", "canned", "pickled", "ground", "minced", "sliced",
    ];
...
pub fn infer_product_type(name_en_lower: &str, name_ru_lower: &str) -> Option<&'static str> {
    ...
    // Seafood (shellfish)
    let seafood_kw = [
        "shrimp", "prawn", "lobster", "crab", "squid", "octopus", "mussel", "oyster", "clam",
        "scallop", "calamari",
    ];
    let seafood_kw_ru = [
        "креветка",
    ...
    // Poultry
    let poultry_kw = ["chicken", "turkey", "duck", "goose", "quail"];
    let poultry_kw_ru = [
        "курица",
        "курин",
        "индейка",
    ...
    // Legume
    let legume_kw = [
        "lentil", "chickpea", "bean", "soybean", "tofu", "tempeh", "edamame", "mung",
    ];
    let legume_kw_ru = ["чечевица", "нут", "фасоль", "соя", "тофу", "темпе", "маш"];
