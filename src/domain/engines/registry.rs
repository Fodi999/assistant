...
pub fn build_catalog() -> ToolCatalogResponse {
    ...
    let engines = vec![
        EngineSummary {
            ...
            tool_count: tools
                .iter()
                .filter(|t| t.engine == EngineKind::Conversion)
                .count(),
        ...
        EngineSummary {
            ...
            tool_count: tools
                .iter()
                .filter(|t| t.engine == EngineKind::Nutrition)
                .count(),
        ...
        EngineSummary {
            ...
            tool_count: tools
                .iter()
                .filter(|t| t.engine == EngineKind::Seasonality)
                .count(),
        ...
        EngineSummary {
            ...
            tool_count: tools
                .iter()
                .filter(|t| t.engine == EngineKind::Recipe)
                .count(),
        ...
        EngineSummary {
            ...
            tool_count: tools
                .iter()
                .filter(|t| t.engine == EngineKind::Kitchen)
                .count(),
    ...
    match tool {
        Convert => vec![
            ...
            ToolParam {
                ...
                r#type: "string",
                required: true,
                description: "Source unit (g, kg, oz, lb, ml, l, cup, tbsp, tsp, ...)",
            },
            ToolParam {
                name: "to",
                r#type: "string",
            ...
            ToolParam {
                ...
                r#type: "string",
                required: false,
                description: "Language: en, ru, pl, uk",
            },
        ],
        ListUnits => vec![ToolParam {
            name: "lang",
            r#type: "string",
            required: false,
        ...
        IngredientScale => vec![
            ToolParam {
                ...
                r#type: "string",
                required: false,
                description: "Ingredient name or slug",
            },
            ToolParam {
                name: "value",
                r#type: "number",
            ...
            ToolParam {
                ...
                r#type: "string",
                required: false,
                description: "Unit (default: g)",
            },
            ToolParam {
                name: "from_portions",
                r#type: "number",
                required: true,
                description: "Original portions",
            },
            ToolParam {
                name: "to_portions",
                r#type: "number",
                required: true,
                description: "Target portions",
            },
            ToolParam {
                name: "lang",
                r#type: "string",
        ...
        Nutrition => vec![
            ...
            ToolParam {
                ...
                r#type: "number",
                required: false,
                description: "Amount (default: 100)",
            },
            ToolParam {
                name: "unit",
                r#type: "string",
        ...
        FishSeason | FishSeasonTable => vec![
            ...
            ToolParam {
                ...
                r#type: "string",
                required: false,
                description: "Region code (default: PL)",
            },
        ],
        SeasonalCalendar => vec![
            ToolParam {
                ...
                r#type: "string",
                required: false,
                description: "Product type (default: seafood)",
            },
            ToolParam {
                name: "lang",
                r#type: "string",
        ...
        RecipeAnalyze => vec![
            ToolParam {
                ...
                r#type: "array",
                required: true,
                description: "List of {slug, grams}",
            },
            ToolParam {
                name: "portions",
                r#type: "number",
        ...
        Yield => vec![
            ...
            ToolParam {
                ...
                r#type: "number",
                required: true,
                description: "Usable weight after cleaning",
            },
        ],
        FoodCost => vec![
            ToolParam {
            ...
            ToolParam {
                ...
                r#type: "number",
                required: false,
                description: "Sell price for margin calc",
            },
        ],
        _ => vec![ToolParam {
            name: "lang",
