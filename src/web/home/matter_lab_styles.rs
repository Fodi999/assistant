...
pub fn matter_panel_styles() -> &'static str {
    ...
    .matter-panel::-webkit-scrollbar { width: 6px; }
    .matter-panel::-webkit-scrollbar-thumb { background: rgba(148, 163, 184, 0.25); border-radius: 6px; }

    .matter-panel .panel-head {
      display: flex; align-items: center; justify-content: space-between;
      margin-bottom: 14px;
    }
    .matter-panel .panel-head h2 {
      margin: 0; font-size: 13px; font-weight: 600; letter-spacing: 0.3px;
      color: #e2e8f0; text-transform: uppercase;
    }
    .matter-panel .panel-head button {
      background: transparent; border: 1px solid rgba(148, 163, 184, 0.18);
      width: 28px; height: 28px; border-radius: 8px;
      color: rgba(226, 232, 240, 0.7); cursor: pointer;
    }

    .matter-panel .setting-row,
    .matter-panel .stats-row,
    .matter-panel .select-row {
      display: flex; align-items: center; justify-content: space-between;
      padding: 8px 0;
      border-bottom: 1px solid rgba(148, 163, 184, 0.08);
    }
    .matter-panel .setting-row span,
    .matter-panel .select-row span,
    .matter-panel .stats-row span {
      color: rgba(148, 163, 184, 0.85);
      font-size: 11px; letter-spacing: 0.4px; text-transform: uppercase;
    }
    .matter-panel .setting-row strong,
    .matter-panel .select-row strong,
    .matter-panel .stats-row strong {
    ...
    .matter-panel .select-row:hover {
      background: rgba(56, 189, 248, 0.06);
    }
    .matter-panel .select-row strong { color: #38bdf8; }

    .matter-panel input[type=range] {
      width: 100%;
      -webkit-appearance: none; appearance: none;
      height: 4px; background: rgba(148, 163, 184, 0.18);
      border-radius: 4px; margin: 6px 0 14px;
    }
    .matter-panel input[type=range]::-webkit-slider-thumb {
      -webkit-appearance: none; appearance: none;
    ...
    .matter-panel .slider-row {
      display: grid;
      grid-template-columns: auto auto;
      grid-template-rows: auto auto;
      grid-template-areas: "lbl val" "sld sld";
      align-items: center; gap: 4px 8px;
      padding-top: 8px;
    }
    .matter-panel .slider-row span { grid-area: lbl;
      color: rgba(148, 163, 184, 0.85);
      font-size: 11px; letter-spacing: 0.4px; text-transform: uppercase;
    }
    .matter-panel .slider-row strong { grid-area: val;
      justify-self: end; color: #fff; font-weight: 600; font-size: 12px;
    }
    .matter-panel .slider-row input { grid-area: sld; margin: 4px 0 12px; }

    .matter-panel .advanced-btn {
    ...
    .matter-panel .advanced-btn:hover {
