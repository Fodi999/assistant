      ...
      <section class="matter-stage">
        ...
        <div id="shortcuts-overlay" style="display:none">
          ...
          <div class="sco-grid" id="sco-list">
            ...
            <span class="sco-key sco-row" data-kw="t solid выдавить 3d kernel">T</span><span class="sco-row" data-kw="t solid выдавить 3d kernel">Выдавить профиль → 3D Solid</span>
        ...
        <nav id="universal-toolbar" aria-label="Инструменты эскиза">
          ...
          <div class="utb-sep"></div>
          <button class="utb-btn" id="btn-fix-point" title="Зафиксировать точку (F)"
                  onclick="if(window.__toggleFixSelectedPoints)window.__toggleFixSelectedPoints();">
            🔒<span class="utb-label">Фикс.</span>
          </button>
          <div class="utb-sep"></div>
