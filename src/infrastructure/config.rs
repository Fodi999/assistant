        ...
        Ok(Self {
            ...
            cors: CorsConfig {
                allowed_origins: env::var("CORS_ALLOWED_ORIGINS")
                    .unwrap_or_else(|_| {
                        "http://localhost:3000,http://localhost:3001,http://localhost:5173,http://127.0.0.1:5173,https://kazaxbud.pages.dev,https://b2b-saas-tau.vercel.app,https://dima-fomin.pl,https://www.dima-fomin.pl".to_string()
                    })
                    .split(',')
