...
pub async fn list_categories() -> Json<CategoriesResponse> {
    Json(CategoriesResponse {
        tools: vec![
            ToolInfo {
                id: "converter",
                path: "/public/tools/convert",
                description: "Universal unit converter (mass & volume)",
            },
            ToolInfo {
                id: "units",
                path: "/public/tools/units",
                description: "List all supported units with labels",
            },
            ToolInfo {
                id: "nutrition",
                path: "/public/tools/nutrition",
                description: "Nutrition calculator (supports any unit)",
            },
            ToolInfo {
                id: "fish-season",
                path: "/public/tools/fish-season",
                description: "Fish seasonality calendar (single fish)",
            },
            ToolInfo {
                id: "fish-season-table",
                path: "/public/tools/fish-season-table",
                description: "Full fish seasonality table with catalog data (name, image)",
            },
            ToolInfo {
                id: "scale",
                path: "/public/tools/scale",
                description: "Recipe portion scaler",
            },
            ToolInfo {
                id: "yield",
                path: "/public/tools/yield",
                description: "Cooking yield & waste calculator",
            },
            ToolInfo {
                id: "ingredient-equivalents",
                path: "/public/tools/ingredient-equivalents",
                description: "Convert ingredient to all units via density",
            },
            ToolInfo {
                id: "food-cost",
                path: "/public/tools/food-cost",
                description: "Food cost, margin & markup calculator",
            },
            ToolInfo {
                id: "ingredient-suggestions",
                path: "/public/tools/ingredient-suggestions",
                description: "Suggest ingredients by volume unit with grams",
            },
            ToolInfo {
                id: "popular-conversions",
                path: "/public/tools/popular-conversions",
                description: "Curated popular cooking conversions (SEO)",
            },
            ToolInfo {
                id: "ingredient-scale",
                path: "/public/tools/ingredient-scale",
                description: "Scale an ingredient between portion sizes",
            },
            ToolInfo {
                id: "measure-conversion",
                path: "/public/tools/measure-conversion",
                description: "SEO: how many grams in a cup/tbsp/tsp of an ingredient",
            },
            ToolInfo {
                id: "ingredient-measures",
                path: "/public/tools/ingredient-measures",
                description: "SEO: full cup/tbsp/tsp grams table for an ingredient",
            },
        ],
    })
}
